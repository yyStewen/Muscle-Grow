...
public class WorkspaceServiceImpl implements WorkspaceService {
     ...
     * @return
     */
    public SupplementOverViewVO getSupplementOverView() {
        Map map = new HashMap();
        map.put("status", StatusConstant.ENABLE);
        Integer sold = supplementMapper.countByMap(map);

        map.put("status", StatusConstant.DISABLE);
        Integer discontinued = supplementMapper.countByMap(map);

        return SupplementOverViewVO.builder()
                .sold(sold)
